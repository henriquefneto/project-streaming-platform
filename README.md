...
Este projeto tem como objetivo implementar progressivamente e de forma didática uma aplicação web inspirada na plataforma de Live Streaming "Twitch", onde se é possível assistir a transmissões ao vivo e iniciar sua própria transmissão.
